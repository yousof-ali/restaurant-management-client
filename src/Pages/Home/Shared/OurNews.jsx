        ...
        my-10'>
            ...
            <div className='flex flex-col mx-2 md:flex-row gap-6'>
               <div className='flex-1 overflow-hidden'>
                <img className=' cursor-pointer transition-transform duration-800  transform hover:scale-110' src="/n1.jpg" alt="" />
               </div>
            ...
            <div className='flex flex-col mx-2 mt-4 md:flex-row-reverse gap-6'>
               ...
               <div className='flex-1 overflow-hidden'>
                <img className=' cursor-pointer transition-transform duration-800  transform hover:scale-110' src="/n2.jpg" alt="" />
               </div>
               <div className='flex-1 md:mt-6'>
                  <p className='text-red-500 font-bold'>News</p>
